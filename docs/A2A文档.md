...
> An open protocol enabling Agent-to-Agent interoperability, bridging the gap between `opaque` agentic systems. ![](./Technical Documentation_files/a2a_actors.png)
